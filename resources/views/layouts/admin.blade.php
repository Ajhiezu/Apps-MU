...
<head>
    ...
    <!-- Favicons -->
    <link href="{{asset('asset/img/icon_Apps_Mu.svg')}}" rel="icon">
    <link href="{{asset('asset/Admin/assets/img/apple-touch-icon.png')}}" rel="apple-touch-icon">
    ...
    <link href="{{asset('asset/Admin/assets/vendor/boxicons/css/boxicons.min.css')}}" rel="stylesheet">
    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        ...
        <div class="d-flex align-items-center justify-content-between">
            <a href="index.html" class="logo d-flex align-items-center">
                <img src="{{asset('asset/img/icon_Apps_Mu.svg')}}" alt="">
                <span class="d-none d-lg-block">AppsMu</span>
            </a>
            ...
            <ul class="d-flex align-items-center">
                ...
                <li class="nav-item dropdown pe-3">
                    ...
                    <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
                        <img src="{{asset('asset/Admin/assets/img/profile-img.jpg')}}" alt="Profile"
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
                ...
                <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    ...
                    <li>
                        <a href="components-accordion.html">
                            <i class="bi bi-circle"></i><span>Product Edit</span>
                        </a>
                    </li>
                </ul>
                ...
                <ul id="forms-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    ...
                    <li>
                        <a href="forms-layouts.html">
                            <i class="bi bi-circle"></i><span>Brand Edit</span>
                        </a>
                    </li>
                </ul>
            </li><!-- End Forms Nav -->
                ...
                <ul id="tables-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    ...
                    <li>
                        <a href="tables-data.html">
                            <i class="bi bi-circle"></i><span>Category Edit</span>
                        </a>
                    </li>
                </ul>
            </li><!-- End Tables Nav -->
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" data-bs-target="#Coupon-nav" data-bs-toggle="collapse" href="#">
                    <i class="bi bi-cash-coin"></i><span>Coupon</span><i class="bi bi-chevron-down ms-auto"></i>
                </a>
                <ul id="Coupon-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    <li>
                        <a href="tables-general.html">
                            <i class="bi bi-circle"></i><span>Coupon Add</span>
                        </a>
                    </li>
                    <li>
                        <a href="tables-data.html">
                            <i class="bi bi-circle"></i><span>Coupon Edit</span>
                        </a>
                    </li>
                </ul>
            </li><!-- End Tables Nav -->
